...
const StatCard = ({ icon: Icon, title, value, change, isPositive }) => {
  return (
    <div className="bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-[#334155] rounded-xl p-5 flex flex-col justify-between h-[120px]">
      ...
      <div className="mt-2 flex items-end justify-between">
        <div>
          ...
          <div className="flex items-center gap-1 mt-1 text-xs">
            ...
            {title !== "Products Listed" && <span className="text-slate-400 dark:text-slate-500">vs last 7 days</span>}
          </div>
        </div>
        
        {title === "Products Listed" ? (
          <div className="w-16 h-8 flex flex-col justify-end pb-1">
